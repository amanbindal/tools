    ...
    function renderTableBody() {
      ...
      for (const item of appData) {
        ...
        if (data.entry) {
            ...
            if (data.entry === 'UCP' && absUcp <= 1) isEntryNear = true;
            else if (data.entry === 'LCP' && absLcp <= 1) isEntryNear = true;
            else if (data.entry === 'MCP' && absMcp <= 1) isEntryNear = true;
            else if (data.entry === 'MA200' && absMa200 <= 1) isEntryNear = true;
            else if (data.entry === 'LCP/MA200' && (absLcp <= 1 || absMa200 <= 1)) isEntryNear = true;
            else if (data.entry === 'Lcp-2S' && absLcp <= 1) isEntryNear = true;
        }
